...
describe('DELETE /todos/:id',(done) => {
  ...
  it('should not remove a todo not ownd by user',(done) => {
    var hexId = todos[1]._id.toHexString();
   request(app) 
       .delete(`/todos/${hexId}`)
       .set('x-auth', users[0].tokens[0].token)
...
describe('POST /users',() => {
   ...
   request(app)
    ...
    it('should return validation errors if invalid email request',(done) => {
      request(app)
      .post('/users')
      .send({
        email : '123.com',
  ...
  it('should return validation errors if invalid password request',(done) => {
    request(app)
    .post('/users')
    .send({
      email : 'danny@123.com',
...
describe('POST /users/login',() => {
   ...
   request(app)
    ...
    it('should reject invalid login',(done) => {
       request(app)
        .post('/users/login')
        .send({email:users[1].email,password:'XYZABCDERS'})
        .expect(400)
        .expect((res) => {
